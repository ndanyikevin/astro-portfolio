...
export default function Work({ isDarkMode }) {
    ...
    return (
        ...
        >
            ...
            >
                My latest work showcases a responsive, high-performance web application
                built with React.js, demonstrating expertise in modern frontend
            ...
            <motion.a
                href={'/'}
                className="w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-150 dark:text-white dark:border-white dark:hover:bg-darkHover"
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
