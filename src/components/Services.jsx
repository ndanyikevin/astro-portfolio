...
export default function Services({isDarkMode}) {
    ...
    return (
        ...
        >
            ...
            >
                I offer professional web and mobile app development services using modern
                technologies like Next.js, React Native, and Prisma to build efficient,
            ...
            >
                {serviceData.map(({ icon, title, description }, index) => {
                    ...
                    return (
                        <motion.div
                            key={index}
                            className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-150 hover:shadow-black dark:bg-darkHover dark:hover:shadow-white dark:hover:bg-darkHover"
                            whileHover={{ scale: 1.05 }}
                        >
                            <img src={icon} alt="service image" className="w-10" />
